...
#define GL_GET_PROC_ADDRESS(proc) wglGetProcAddress(proc)

#elif __linux__
#include "extern/glxext.h"
...
#define LOAD_GL_EXTENSION(type, func) \
...
#elif __linux__
    LOAD_GL_EXTENSION(PFNGLXCREATECONTEXTATTRIBSARBPROC, glXCreateContextAttribsARB);
    LOAD_GL_EXTENSION(PFNGLXSWAPINTERVALEXTPROC, glXSwapIntervalEXT);
#endif
    ...
    LOAD_GL_EXTENSION(PFNGLUNIFORM2FPROC, glUniform2f);
    LOAD_GL_EXTENSION(PFNGLUNIFORM3FPROC, glUniform3f);
    LOAD_GL_EXTENSION(PFNGLUNIFORM4FPROC, glUniform4f);
